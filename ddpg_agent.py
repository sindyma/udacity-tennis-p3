...
LR_DECAY = 0.8          # rate at which to decay LR
LR_ACTOR_MIN = 1e-4     # min learning rate to decay to for the actor
LR_CRITIC_MIN = 1e-4    # min learning rate to decay to for the critic
